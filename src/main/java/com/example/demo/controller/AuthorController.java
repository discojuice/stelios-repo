...
//
//    @GetMapping("/{id}")
//    public ResponseEntity<Author> one(@PathVariable Long id) {
//        return authorRepo.findById(id).map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
//    }
//
//    @PostMapping
...
//                    return ResponseEntity.ok(authorRepo.save(existing));
//                })
